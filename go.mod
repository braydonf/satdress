...
require (
	...
	github.com/lightningnetwork/lnd v0.21.2-beta // indirect
...
replace github.com/fiatjaf/lightningd-gjson-rpc => ./lib/lightningd-gjson-rpc

replace github.com/nbd-wtf/ln-decodepay => ./lib/ln-decodepay
